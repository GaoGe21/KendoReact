...
import { classNames, Keys, dispatchEvent, guid } from '@progress/kendo-react-common';
...
var ColorPalette = /** @class */ (function (_super) {
    ...
    ColorPalette.prototype.render = function () {
        ...
        if (paletteInfo.colors.length) {
            return (React.createElement("div", { className: className, onFocus: this.onFocus, onBlur: this.onBlur, onKeyDown: this.onKeyDown, "aria-disabled": this.props.disabled ? 'true' : undefined, "aria-activedescendant": selectedCellCoords && this.createCellId(selectedCellCoords), tabIndex: this.props.disabled ? undefined : this.props.tabIndex || 0, ref: function (el) { return _this.wrapper = el; } },
