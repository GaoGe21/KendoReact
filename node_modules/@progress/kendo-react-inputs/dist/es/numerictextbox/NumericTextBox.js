...
var NumericTextBox = /** @class */ (function (_super) {
     ...
     * @hidden
     */
    NumericTextBox.getDerivedStateFromProps = function (props, state) {
    ...
    NumericTextBox.prototype.render = function () {
        ...
        var numerictextbox = (React.createElement("span", { dir: this.props.dir, style: !this.props.label
                ...
                : undefined, className: 'k-widget k-numerictextbox' + (this.props.className ? ' ' + this.props.className : ''), "aria-disabled": this.props.disabled ? 'true' : undefined },
                ...
                this.props.spinners &&
                    React.createElement("span", { className: "k-select", onMouseDown: function (e) {
                        ...
                        React.createElement("span", { className: "k-link k-link-increase", "aria-label": localizationService
                                ...
                                .toLanguageString(numericIncreaseValue, messages[numericIncreaseValue]), onClick: this.increase },
                        ...
                        React.createElement("span", { className: "k-link k-link-decrease", "aria-label": localizationService
                                ...
                                .toLanguageString(numericDecreaseValue, messages[numericDecreaseValue]), onClick: this.decrease },
                            React.createElement("span", { className: "k-icon k-i-arrow-s" }))))));
        return this.props.label
            ? (React.createElement(FloatingLabel, { id: inputId, value: this.valueAsLocalString, valid: isValid, placeholder: this.props.placeholder, label: this.props.label, children: numerictextbox, style: { width: this.props.width } }))
            : numerictextbox;
    };
    ...
    NumericTextBox.prototype.triggerChange = function (newState, event) {
        ...
        if (shouldFireEvent) {
            dispatchEvent(this.props.onChange, event, this, { value: this.valueDuringOnChange });
        }
...
registerForLocalization(NumericTextBox);
