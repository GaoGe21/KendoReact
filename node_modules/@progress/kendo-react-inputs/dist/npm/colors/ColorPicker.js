...
exports.ColorPicker = React.forwardRef(function (props, target) {
    var popupSettings = props.popupSettings, gradientSettings = props.gradientSettings, paletteSettings = props.paletteSettings, disabled = props.disabled, _a = props.tabIndex, tabIndex = _a === void 0 ? 0 : _a, view = props.view, icon = props.icon, onChange = props.onChange, onFocus = props.onFocus, onBlur = props.onBlur;
    ...
    var _c = React.useState(props.defaultValue), stateValue = _c[0], setStateValue = _c[1];
    var _d = React.useState(false), stateOpen = _d[0], setStateOpen = _d[1];
    ...
    var dir = kendo_react_common_1.useRtl(focusableElementRef, props.dir);
    ...
    return (React.createElement("span", { className: 'k-widget k-colorpicker', dir: dir },
        React.createElement("span", { className: className, ref: focusableElementRef, tabIndex: disabled ? undefined : tabIndex, onKeyDown: onKeyDownHandler, onFocus: onFocusHandler, onBlur: onBlurHandler },
            React.createElement(Picker_1.Picker, { dir: dir, open: open, onOpen: onOpenHandler, popupAnchor: focusableElementRef.current || undefined, popupSettings: __assign({}, popupSettings), input: (!iconClassName ? (React.createElement("span", { className: 'k-selected-color', style: { backgroundColor: value } }, !value && React.createElement("span", { className: 'k-icon k-i-line' }))) : (React.createElement("span", { className: kendo_react_common_1.classNames('k-tool-icon', iconClassName) },
                    React.createElement("span", { className: 'k-selected-color', style: { backgroundColor: value } })))), button: (React.createElement("span", { onClick: onClickHandler, className: 'k-select' },
