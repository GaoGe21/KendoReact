...
var Slider = /** @class */ (function (_super) {
    ...
    Slider.prototype.render = function () {
        ...
        var sliderItemsStyle = this.props.vertical
            ...
            : {};
        return (React.createElement("div", { "aria-valuemin": this.props.min, "aria-valuemax": this.props.max, "aria-valuenow": this.state.value, "aria-disabled": this.props.disabled ? 'true' : undefined, role: "slider", style: this.props.style, tabIndex: this.props.disabled ? undefined :
                (this.props.tabIndex || 0), onFocus: this.onFocus, onBlur: this.onBlur, onKeyDown: this.onKeyDown, className: kendo_react_common_1.classNames('k-slider k-widget k-state-default', this.props.className, {
                    ...
                    React.createElement(kendo_react_common_1.Draggable, { onDrag: this.dragOver, onPress: this.dragStart },
                        React.createElement("div", { className: "k-slider-track-wrap", style: __assign({ flexGrow: 1, position: 'relative', touchAction: 'none' }, trackStyles) },
                            ...
                            React.createElement("div", { className: "k-slider-track", style: this.props.vertical
                                    ? { bottom: 0, height: '100%' }
                                    : { left: 0, width: '100%' }, ref: function (el) { return _this._sliderTrack = el; } },
                                ...
                                React.createElement("a", { className: "k-draghandle", title: lS.toLanguageString(messages_1.sliderDragTitle, messages_1.messages[messages_1.sliderDragTitle]), style: this.props.vertical
                                        ...
                                        : { left: 'calc(' + percentValue + '% - 8px)', zIndex: 1 } }))))))));
    };
